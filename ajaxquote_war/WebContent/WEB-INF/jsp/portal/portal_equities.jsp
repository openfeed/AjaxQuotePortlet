...
<portlet:scope>
	<portlet:portlet context="/openfeed" portletname="eplt-mini-anonymous"
		windowId="firstWnd" />
	<portlet:portlet context="/openfeed" portletname="eplt-anonymous"
		windowId="secondWnd" />
</portlet:scope>
		...
		<tr>
			<td>
									...
									<td>
										<TABLE WIDTH="450">
											<TR>
												...
												<TD ALIGN="right"><a
													href="<portlet:state url='/openfeed/eplt-mini-anonymous' 
				...
				windowId='firstWnd' portletMode='edit'/>">edit</a>
								...
								<tr>
									<td><portlet:insert url="openfeed/eplt-mini-anonymous"
		...
		<tr>
			<td>
									...
									<td>
										<TABLE WIDTH="450">
											<TR>
												...
												<TD ALIGN="right"><a
													href="<portlet:state url='/openfeed/eplt-anonymous' 
				...
				windowId='secondWnd' portletMode='edit'/>">edit</a>
								...
								<tr>
									<td><portlet:insert url="openfeed/eplt-anonymous"
